...
class ScoringModel(nn.Module):
    def __init__(self, base_model_path):
        ...
        # 多头注意力层
        self.multihead_attention = nn.MultiheadAttention(embed_dim=self.config.hidden_size, num_heads=1, batch_first=True)
...
def train(batch_size, num_epochs):
    ...
    # 将结果保存到一个Excel工作表中
    df_results.to_excel('./results/results_30.xlsx', index=False, sheet_name='Results')
